      ...
      >
        ...
        >
          ...
          <div className="mt-8 flex flex-col gap-3">
            ...
            <Link
              href="/sign-in/line"
              className="flex w-full items-center justify-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-white transition hover:opacity-90"
          ...
          <p className="mt-6 text-center text-xs text-slate-400">
            หลังลงชื่อเข้าใช้จะนำคุณไปยังแดชบอร์ด
          </p>
        </div>
